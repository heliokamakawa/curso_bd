...
07) Listar o nome de estado e quantos funcionários tem em cada cidade. Mostre somente os estados que apresentam mais que 3 cliente.
08) Listar o nome de estado e quantos clientes tem em cada estado. Mostre somente os estados que apresentam mais que 3 cidades cadastradas e menos que 5 clientes em cada estado.
09) Listar o nome das categorias dos produtos e quantos produtos tem em cada categoria. Apresente somente as categorias que tem a quantidade de prodtuos maior que a média.
10) Listar o nome das categorias dos produtos e quantos produtos tem em cada categoria. Apresente somente as categorias que tem a quantidade de prodtuos maior que a média.
